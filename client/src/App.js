...
const App = () => {
  ...
  useEffect(() => {
    ...
    console.log('App.js setupProvider: ', setupProvider._currentValue)
    console.log("App.js end initial load", setup.initialized, setup.loggedIn);
  }, []);
  console.log('App.js SetupContext: ', SetupContext.Provider)
